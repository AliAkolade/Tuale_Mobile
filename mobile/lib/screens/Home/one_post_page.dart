...
class _OnePostState extends State<OnePost> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Material(
            child: Obx(() => post.isLoading.value
                ? Center(
              ...
              child: Column(children: [
                GestureDetector(
                    ...
                    child: Row(
                        ...
                        children: [
                          ...
                          const Spacer(flex: 1),
                          Text(post.postdetails.value.username,
                              style: TextStyle(
                                  color: Colors.white,
                                  fontFamily: 'Poppins',
                                  fontSize: 18.sp,
                ...
                Container(
                    ...
                    child: Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          Text(post.postdetails.value.postText,
      ...
      Navigator.of(context).pushAndRemoveUntil(
          MaterialPageRoute(
              builder: (context) => NavBar(
                  index: 1, deepLinkId: '', deepLinkPath: '', deepLink: false)),
...
Widget _commentsectionModal(BuildContext context) {
                        ...
                        GestureDetector(
                            onTap: () async {
                              ...
                              List result = await Api()
                                  .commentOnAPost(widget.posts!.id, comment);
