...
class _SelectBankDialogState extends State<SelectBankDialog> {
  ...
  loadUserBankAccount() async {
    ...
    print("Fabio : $res");
    if(res!=null) print("Fabio_account : ${res["account_number"]}");
  }
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    BioField(
                      ...
                      onChanged: (text) async {
                        ...
                        if(accountNbr.text.isNotEmpty && bankCode!="" ){
                          userAccountName.text = await api.checkAccountNumber(accountNbr.text.trim(),bankCode);
                          ...
                          TextDropdownFormField(
                            ...
                            onChanged: (dynamic text) async {
                              if(text.isNotEmpty) {
                                ...
                                print("bankListName : ${bankListName.indexOf(text)}");
                    ...
                    Center(
                        child: ElevatedButton(
                      onPressed: () async {
                        var res = await api.createWithdrawalAccount(userAccountName.text, accountNbr.text, bankCode);
                        if(res[0]) {
                          showDialog(
                          context: context,
                          builder: (BuildContext context) {
